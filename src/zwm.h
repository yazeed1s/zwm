...
xcb_atom_t 				  get_atom(char *atom_name, xcb_connection_t *con);
...
int 					  change_border_attr(xcb_connection_t *cn, client_t *cl, uint32_t b_c, uint32_t b_w, bool stack);
int 					  change_window_attr(xcb_connection_t *cn, xcb_window_t win, uint32_t attr, const void *);
